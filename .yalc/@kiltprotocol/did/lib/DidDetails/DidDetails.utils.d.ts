 ...
 */
import type { IDidDetails, IDidKeyDetails, IIdentity, KeystoreSigner, SubmittableExtrinsic } from '@kiltprotocol/types';
 ...
 */
export declare function writeNewDidFromDidDetails(didDetails: IDidDetails, submitter: IIdentity['address'], signer: KeystoreSigner): Promise<SubmittableExtrinsic>;
/**
 ...
 */
export declare function deriveDidPublicKey<T extends string>(typeRegistry: TypeRegistry, publicKey: string | Uint8Array, type: T, controller?: string): IDidKeyDetails<T>;
